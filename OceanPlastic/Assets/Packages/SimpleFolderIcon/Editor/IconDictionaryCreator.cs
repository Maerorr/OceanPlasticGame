...
namespace SimpleFolderIcon.Editor
{
    ...
    {
        private const string AssetsPath = "Packages/SimpleFolderIcon/Icons";
        ...
        internal static void BuildDictionary()
        {
            ...
            {
                var texture = (Texture)AssetDatabase.LoadAssetAtPath($"Assets/Packages/SimpleFolderIcon/Icons/{f.Name}", typeof(Texture2D));
            ...
            {
                var folderIconSO = (FolderIconSO)AssetDatabase.LoadAssetAtPath($"Assets/Packages/SimpleFolderIcon/Icons/{f.Name}", typeof(FolderIconSO));
